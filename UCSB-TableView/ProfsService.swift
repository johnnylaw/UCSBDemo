...
class ProfsService {
    static let professors = [
        ...
        Professor(name: "Çetin Kaya Koç", title: "Lecturer", url: "https://www.cs.ucsb.edu/people/faculty/koç", image: nil),
        Professor(name: "Timothy Sherwood", title: "Professor & Vice Chair", url: "https://www.cs.ucsb.edu/people/faculty/sherwood", image: UIImage(named: "")),
